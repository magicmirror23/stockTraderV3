...
| 9 | `rsi_14` | float | 14-day Relative Strength Index (0â€“100) |
| 10 | `macd` | float | MACD line (EMA12 â€“ EMA26) |
| 11 | `macd_signal` | float | 9-day EMA of MACD line |
| 12 | `macd_hist` | float | MACD histogram (macd â€“ signal) |
...
| 18 | `volume_spike` | int | 1 if volume > 2Ã— 20-day mean, else 0 |
...
All transforms are deterministic â€” no randomness is involved.  Given the same
