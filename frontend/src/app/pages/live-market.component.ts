...
import { LiveStreamService, LiveTick, WatchlistItem, MarketOverview, CategoryInfo, FeedStatus, MarketSnapshot } from '../services/live-stream.service';
...
@Component({
  ...
  template: `
    ...
    <div class="page">
      ...
      <!-- Controls -->
      <div *ngIf="market && market.phase !== 'open' && market.phase !== 'pre_open' && watchlistArray.length > 0" class="card mb-2 last-close-banner">
        <div class="flex items-center gap-1">
          <span>📊</span>
      ...
      <div class="grid-layout">
        ...
        <div class="card grid-ohlc" *ngIf="selectedTick">
          <h3 class="panel-title">📊 {{ selectedSymbol }} Details</h3>
          <div class="ohlc-grid">
            <div class="ohlc-item">
