...
try:
    ...
    logger.warning("torch not installed â€” sequence models unavailable")
...
class _GRUFeatureNet(nn.Module if TORCH_AVAILABLE else object):
    ...
    Architecture: GRU(48) â†’ Dropout â†’ GRU(24) â†’ Dropout â†’ Dense(12, relu) â†’ Dense(1, sigmoid)
...
class GRUFeatureExtractor:
    ...
    def train(
        ...
        # Use raw logit output for BCEWithLogitsLoss â€” bypass sigmoid
