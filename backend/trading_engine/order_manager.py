...
def _calibrated_size_factor(confidence: float) -> float:
    """Map calibrated confidence âˆˆ [0, 1] to a sizing factor âˆˆ (0, 1].
...
def _risk_adjusted_utility(
    ...
    Higher values â†’ larger allocation.
    """
...
class OrderManager:
    ...
    # ------------------------------------------------------------------ #
    #  Option prediction â†’ intent (single-leg CE / PE)                    #
    # ------------------------------------------------------------------ #
