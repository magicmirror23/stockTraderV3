...
def calculate_charges(
    ...
    # Brokerage: min(â‚¹20, 0.03% of trade value) â€” per leg
...
def estimate_breakeven_move(
    ...
    """Estimate the minimum price move (in â‚¹) needed to break even after charges.
