...
# NSE holidays â€“ extend as needed each year
...
def get_market_status() -> MarketStatus:
    ...
    if now.weekday() >= 5:
        ...
        return MarketStatus(
            ...
            message="Market closed â€“ Weekend",
            ist_now=ist_now_str,
    ...
    if _is_holiday(now):
        ...
        return MarketStatus(
            ...
            message="Market closed â€“ NSE Holiday",
            ist_now=ist_now_str,
            next_event="Market Opens",
            next_event_time=next_open.strftime("%Y-%m-%d %H:%M IST"),
            seconds_to_next=secs,
    ...
    if t < PRE_OPEN_START:
        ...
        return MarketStatus(
            ...
            message="Market closed â€“ Opens at 9:00 AM IST",
            ist_now=ist_now_str,
    ...
    if PRE_OPEN_START <= t < PRE_OPEN_END:
        ...
        return MarketStatus(
            ...
            message="Pre-open session active (9:00 â€“ 9:15 AM)",
            ist_now=ist_now_str,
            next_event="Market Opens",
            next_event_time=open_dt.strftime("%H:%M IST"),
            seconds_to_next=secs,
    ...
    if MARKET_OPEN <= t < MARKET_CLOSE:
        ...
        return MarketStatus(
            ...
            message="Market is OPEN (9:15 AM â€“ 3:30 PM IST)",
            ist_now=ist_now_str,
    ...
    if MARKET_CLOSE <= t < POST_CLOSE_END:
        ...
        return MarketStatus(
            ...
            message="Post-close session (3:30 â€“ 4:00 PM)",
            ist_now=ist_now_str,
